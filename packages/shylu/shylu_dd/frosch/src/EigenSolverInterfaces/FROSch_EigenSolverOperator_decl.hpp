 ...
 * @brief Class for operators used in the generalized eigenvalue problem of an adaptive coarse space.
 *
 * @details
...
template <typename SC = Tpetra::Details::DefaultTypes::scalar_type, 
...
class EigenSolverOperator {
  ...
  public:
     ...
     * @brief Apply
     */
    virtual void apply(const Tpetra::MultiVector<SC, LO, GO> &X, Tpetra::MultiVector<SC, LO, GO> &Y) const {}
